...
(function($) {
	"use strict";
		...
		function doThis(){
				...
				if(isOn === 13) { fx.html('生活不止眼前的苟且，还有诗与远方'); sets = {animation: 1, animationType: "in", restoreHTML: false,onComplete:false};}else{
				(isOn < 13) ? isOn++ : isOn = 0;	
				switch(isOn) {
					case 1:						
					sets = {
